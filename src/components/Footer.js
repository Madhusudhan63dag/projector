      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10">
          <div>
            <div className="flex items-center mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 sm:h-8 sm:w-8 mr-2 text-[#36A8DA]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
              </svg>
              <h3 className="text-lg sm:text-xl font-bold">I & I vlog camera</h3>
            </div>
            <p className="text-gray-500 mb-6">
              The ultimate 4G‑connected, 4K Ultra HD portable recorder for professionals and enthusiasts.
            </p>
            <div className="flex space-x-4">
              <a href="#" aria-label="Facebook" className="text-gray-500 hover:text-[#36A8DA] transition-colors">
                <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/>
                </svg>
              </a>
              <a href="#" aria-label="Instagram" className="text-gray-500 hover:text-[#FD5201] transition-colors">
                <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" aria-label="Twitter" className="text-gray-500 hover:text-[#36A8DA] transition-colors">
                <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723 9.99 9.99 0 01-3.127 1.195 4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                </svg>
              </a>
              <a href="#" aria-label="YouTube" className="text-gray-500 hover:text-[#FD5201] transition-colors">
                <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-8 sm:mt-0">
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li><a href="#how-it-works" className="text-gray-500 hover:text-white hover:underline decoration-[#FD5201] transition-colors">How It Works</a></li>
          ...
          <div className="mt-8 md:mt-0">
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li><a href="#" className="text-gray-500 hover:text-white hover:underline decoration-[#36A8DA] transition-colors">Returns & Warranty</a></li>
              <li><a href="#" className="text-gray-500 hover:text-white hover:underline decoration-[#36A8DA] transition-colors">Shipping Information</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-900 mt-10 sm:mt-12 pt-6 sm:pt-8 text-sm text-center">
          ...
          <div className="mt-3 sm:mt-4 space-x-3 sm:space-x-6 flex flex-wrap justify-center">
            ...
            <a href="#" className="text-gray-500 hover:text-[#36A8DA] transition-colors">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
